...
M.hide_statusline = function()
   local hidden = require("nvoid.core.utils").load_config().plugins.options.statusline.hidden
   local shown = require("nvoid.core.utils").load_config().plugins.options.statusline.shown
   local api = vim.api
...
M.load_config = function()
   ...
   local chadrcExists, change = pcall(require, "nvoidrc")
