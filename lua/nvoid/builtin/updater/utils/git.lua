...
local misc = require "nvoid.builtin.updater.utils.misc"
...
M.update_url = "https://github.com/nvoid-lua/nvoid"
M.update_branch = "main"
...
M.get_stash_list = function()
  local stash_list_string = utils.cmd("git -C " .. M.config_path .. " stash list --pretty=format:%gd", true)
