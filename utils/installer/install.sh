...
declare -xr NV_INSTALL_PREFIX="${NV_INSTALL_PREFIX:-"$HOME/.local"}"
...
function main() {
	...
	echo "You can start it by running: $NV_INSTALL_PREFIX/bin/$NVIM_APPNAME"
...
function check_system_deps() {
	...
	validate_install_prefix "$NV_INSTALL_PREFIX"
...
function setup_nvoid() {
	...
	"$NV_INSTALL_PREFIX/bin/$NVIM_APPNAME" --headless -c 'quitall'
